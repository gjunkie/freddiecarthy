    ...
    <main className={globalStyles.main}>
      ...
      <div className={styles.copyGroup}>
        ...
        <div className={styles.paragraphContainer}>
          ...
          <p className={styles.copy}>Before that I was on my way to be a <span className={styles.highlightTwo}>firefighter</span>. Fast forward a couple of years, and countless hours learning <span className={styles.highlightThree}>frontend development</span>, and I landed my first job at a start up.</p>
      ...
      <ul className={styles.squareList}>
        ...
        <li className={styles.square}>
          <h3>How I Work</h3>
          <p>I take pride in my workspace and my software development tools. I use a varity of tools to get my work done. <span className={styles.highlightSeven}><Link href="/how-i-work">Take a peek at how I work</Link></span>!</p>
        </li>
      </ul>
    </main>
  </>
