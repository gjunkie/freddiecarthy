      ...
      <CopyGroup>
        ...
        <ParagraphContainer>
          ...
          <ArrowOne>
            ...
            <path className="arrow-one-tail-1" d="M2 298C5.99733 295.71 13.6784 293.618 16 290" stroke="white" strokeWidth="3" stroke-linecap="round"/>
            <path className="arrow-one-tail-2" d="M2 300C4.48622 302.735 8 306.357 8 310" stroke="white" strokeWidth="3" stroke-linecap="round"/>
        ...
        <ParagraphContainer>
          <ArrowTwo>
            ...
            <path className="arrow-two-tail-1" d="M404.816 177.941C406.232 182.268 407.71 186.624 409.14 190.914" stroke="white" strokeWidth="3" stroke-linecap="round"/>
            <path className="arrow-two-tail-2" d="M398.762 199.562C402.773 197.476 406.593 194.069 410.87 192.643" stroke="white" strokeWidth="3" stroke-linecap="round"/>
            </svg>
          </ArrowTwo>
        ...
        <ParagraphContainer>
          <ArrowThree>
            ...
            <path className="arrow-three-tail-1" d="M8.06931 165.697C4.97688 162.511 3.72777 158.573 1.83252 154.783" stroke="white" strokeWidth="3" stroke-linecap="round"/>
            <path className="arrow-three-tail-2" d="M8.06934 164.918C12.9538 164.918 16.2361 164.794 20.5429 163.358" stroke="white" strokeWidth="3" stroke-linecap="round"/>
            </svg>
          </ArrowThree>
