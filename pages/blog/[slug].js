  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:image" content={`/blog-images/${meta.image}`} key="twimage" />

        {/* Open Graph */}
        <meta property="og:url" content={`/blog/${meta.slug}`} key="ogurl" />
        <meta property="og:image" content={`/blog-images/${meta.image}`} key="ogimage" />
