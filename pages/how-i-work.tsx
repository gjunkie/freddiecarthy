  ...
  return (
    <>
      ...
      <Main>
        ...
        <p>I strongly believe that one should care deeply about the work they do, how they do it, and how they communicate. This does not mean that one should spend a fortune buying fancy gadgets or that engineering should define who you are, it means being intentional about the tools we use and how we use them, the routines we establish, and the way in which we work with others.</p>
        ...
        <DefinitionList>
          ...
          <dt>iPhone 12 Pro</dt>
          <dd>I've been an iPhone user since the introduction of the original in 2007. I will never switch.</dd>
        ...
        <DefinitionList>
          ...
          <dt>Vim</dt>
          <dd>I feel a deep sense of pride in using Vim. When I started my career I didn't really have a preference in which tool I used for editing code and I largely followed the my manager's lead. He used Vim so it must be good. I started using it and quickly fell in love. Why do I love it? For starters it is a tool that does one thing and does it well; editing text. Ultimately this is what my job is.</dd>

          <dt>VimWiki</dt>
          <dd>I'm still trying to find the perfect note taking solution. Being a software engineer and Vim user I spend a lot of time in the Terminal, so I need not only quick ways to campture thoughts, but also easy ways to organize and navigate those notes. VimWiki is my current attempt at solving this.</dd>

          <dt>Things 3</dt>
          <dd>I only recently began using Things as my todo app. For a long time I did this in Vim as well, but ultimately wanted to easily access my lists on the go.</dd>
