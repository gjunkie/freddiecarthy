...
excerpt: "Book Review: Annihilation is a captivating story about exploring the unknown, self discovery, and survival."
...
The film based on the book is only loosely based on this book. It takes some of the overarching themes and plot points, but the main story is completely different. The book is only about 200 pages long, which makes for a very quick read. I recommend this book to anyone looking for a quick fiction fix.
