...
Place that snipped at the bottom of your `install` file and you're ready to go. The last line sources your new `.bash_profile` file once the process is done. **Keep in mind that running this script will replace any dotfiles you've listed in your `files` file!**
