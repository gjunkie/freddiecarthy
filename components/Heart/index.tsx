...
export const Heart = (props: Props) => {
  ...
  const soundPlayer = React.useMemo(
    () =>
      typeof Audio !== 'undefined' && userLikes < 16
        ? new Audio(`/audio/pop${userLikes < 15 ? '1' : '2'}.ogg`)
        : undefined,
    [userLikes]
  )
  ...
  const copy =
    totalLikes === 0 ? 'likes...' : totalLikes === 1 ? 'like!' : 'likes!'
        ...
        <span className={styles.heart}>
          <svg x="0px" y="0px" viewBox="0 0 230 230">
            <linearGradient id="gradient1" x1="0.5" y1="1" x2="0.5" y2="0">
              <stop
                offset="6.25%"
                stopOpacity={userLikes > 0 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="12.5%"
                stopOpacity={userLikes > 1 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="18.75%"
                stopOpacity={userLikes > 2 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="25%"
                stopOpacity={userLikes > 3 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="31.25%"
                stopOpacity={userLikes > 4 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="37.5%"
                stopOpacity={userLikes > 5 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="43.75%"
                stopOpacity={userLikes > 6 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="50%"
                stopOpacity={userLikes > 7 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="56.25%"
                stopOpacity={userLikes > 8 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="62.5%"
                stopOpacity={userLikes > 9 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="68.75%"
                stopOpacity={userLikes > 10 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="75%"
                stopOpacity={userLikes > 11 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="81.25%"
                stopOpacity={userLikes > 12 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="87.5%"
                stopOpacity={userLikes > 13 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="93.75%"
                stopOpacity={userLikes > 14 ? '1' : '0'}
                stopColor="#d31717"
              />
              <stop
                offset="100%"
                stopOpacity={userLikes > 15 ? '1' : '0'}
                stopColor="#d31717"
              />
            </linearGradient>
